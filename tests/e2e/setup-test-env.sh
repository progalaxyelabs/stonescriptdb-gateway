...
echo "Platform 1: ${APP1_PLATFORM_CODE:-myapp} / ${APP1_TENANT_SLUG:-test-tenant}"
echo "Platform 2: ${APP2_PLATFORM_CODE:-otherapp} / ${APP2_TENANT_SLUG:-test-company}"
...
echo "  1. Platform: ${APP1_PLATFORM_CODE:-myapp}, Slug: ${APP1_TENANT_SLUG:-test-tenant}"
echo "  2. Platform: ${APP2_PLATFORM_CODE:-otherapp}, Slug: ${APP2_TENANT_SLUG:-test-company}"
echo ""
